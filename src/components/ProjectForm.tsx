...
const ProjectForm: React.FC<ProjectFormProps> = ({
  ...
  return (
    <Card>
      ...
      <CardContent className={cn("p-4", "grid grid-cols-1 gap-2")}>
        <div className="">
        ...
        <div className="">
          ...
          >
            ...
            <PopoverContent
              align="start"
              className={cn("w-[478px]", "p-0", "max-sm:w-[360px]")}
            >
              <Command>
        ...
        {mode === "create" && (
          <div className={cn("mt-6", "border rounded-md")}>
            <div className={cn("py-2 px-3", "flex items-center gap-3")}>
              <Bot className={cn("flex-shrink-0", "text-muted-foreground")} />

              <div className={cn("me-auto", "space-y-0.5")}>
                <Label
                  htmlFor="ai_generate"
      ...
      <CardFooter className={cn("p-4", "flex justify-end gap-3")}>
        <Button
          variant="secondary"
          onClick={onCancel}
        >
